...
namespace GothamSubway.WinForm
{
    partial class TransferByDurationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            series5.FilterString = "[StationId] = 1 And [TransferId] = 1";
            series5.Name = "승차";
            series5.ValueDataMembersSerializable = "Average";
            sideBySideBarSeriesView3.Transparency = ((byte)(80));
            series5.View = sideBySideBarSeriesView3;
            series6.ArgumentDataMember = "Time";
            series6.CrosshairLabelPattern = "{S} : {V:0.00}";
            series6.FilterString = "[StationId] = 1 And [TransferId] = 2";
            series6.Name = "하차";
            series6.ValueDataMembersSerializable = "Average";
            sideBySideBarSeriesView4.Transparency = ((byte)(80));
            series6.View = sideBySideBarSeriesView4;
            this.chartControl1.SeriesSerializable = new DevExpress.XtraCharts.Series[] {
        series5,
        series6};
            this.chartControl1.Size = new System.Drawing.Size(582, 207);
            ...
            this.chartControl2.Location = new System.Drawing.Point(3, 277);
            this.chartControl2.Name = "chartControl2";
            this.chartControl2.PaletteName = "Aspect";
            series7.ArgumentDataMember = "Date";
            series7.FilterString = "[StationId] = 1 And [TransferId] = 1";
            series7.Name = "승차";
            series7.ValueDataMembersSerializable = "Sum";
            series7.View = splineSeriesView3;
            series8.ArgumentDataMember = "Date";
            series8.FilterString = "[StationId] = 1 And [TransferId] = 2";
            series8.Name = "하차";
            series8.ValueDataMembersSerializable = "Sum";
            series8.View = splineSeriesView4;
            this.chartControl2.SeriesSerializable = new DevExpress.XtraCharts.Series[] {
        series7,
        series8};
            this.chartControl2.Size = new System.Drawing.Size(582, 331);
